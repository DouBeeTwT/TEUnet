...
class Unet(nn.Module):
    def __init__(self,
        ...
        self.UpSampleLayer5 = UpSample(in_channels=hidden_channels*16, out_channels=hidden_channels*8)
        self.UpSampleLayer4 = UpSample(in_channels=hidden_channels*8, out_channels=hidden_channels*4)
        self.UpSampleLayer3 = UpSample(in_channels=hidden_channels*4, out_channels=hidden_channels*2)
        self.UpSampleLayer2 = UpSample(in_channels=hidden_channels*2, out_channels=hidden_channels*1)
